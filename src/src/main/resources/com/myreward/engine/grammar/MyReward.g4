...
*/
myreward_def
	: event_def {System.out.println(current.toString());}
	;
event_def
...
event_name
	...
	;
group_def
	: any_def LBRACE group_events_def RBRACE
	| all_def LBRACE group_events_def RBRACE
	;
group_events_def
	: event_def (grouping_logic_def event_def)* 	# eventGrouping
	;
grouping_logic_def
	: OR		# logicalOr
	| AND		# logicalAnd
