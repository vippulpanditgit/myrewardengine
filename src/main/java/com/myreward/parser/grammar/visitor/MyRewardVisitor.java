...
import com.myreward.parser.grammar.MyRewardParser.Any_defContext;
import com.myreward.parser.grammar.MyRewardParser.Between_defContext;
import com.myreward.parser.grammar.MyRewardParser.Event_defContext;
import com.myreward.parser.grammar.MyRewardParser.Event_modifier_defContext;
import com.myreward.parser.grammar.MyRewardParser.Event_nameContext;
import com.myreward.parser.grammar.MyRewardParser.Gatekeeper_defContext;
import com.myreward.parser.grammar.MyRewardParser.Group_defContext;
import com.myreward.parser.grammar.MyRewardParser.Group_events_defContext;
import com.myreward.parser.grammar.MyRewardParser.Import_defContext;
import com.myreward.parser.grammar.MyRewardParser.Import_nameContext;
...
import com.myreward.parser.grammar.MyRewardParser.Package_defContext;
import com.myreward.parser.grammar.MyRewardParser.Package_nameContext;
import com.myreward.parser.grammar.MyRewardParser.Priority_defContext;
import com.myreward.parser.grammar.MyRewardParser.Repeat_defContext;
import com.myreward.parser.grammar.MyRewardParser.Repeat_frequency_defContext;
import com.myreward.parser.grammar.MyRewardParser.Reward_defContext;
import com.myreward.parser.grammar.MyRewardParser.Reward_quantity_defContext;
import com.myreward.parser.grammar.MyRewardParser.Sequence_defContext;
import com.myreward.parser.grammar.MyRewardParser.Show_defContext;
import com.myreward.parser.metamodel.BaseMetaModel;
				...
				if(ctx.getParent().getParent().getParent()!=null && ctx.getParent().getParent().getParent() instanceof Group_defContext) {
					...
					if(groupDefContext.groupDefMetaModel.operationIndex<2) {
						if(groupDefContext.groupDefMetaModel.logic==GroupMetaModel.GROUP_LOGIC.ANY) {
							...
							groupDefContext.groupDefMetaModel.instructionStack.add("ifref_num("+groupEventId+","+groupDefContext.groupDefMetaModel.ordinalMetaModel.ordinal+")");
