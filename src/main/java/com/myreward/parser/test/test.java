...
public class test {
	...
	public static void main(String[] args) {
		try {
			...
			String oneEvent1 = "package global event(H).between('2000-07-17T19:20:30.45+01:00','2017-07-16T19:20:30.45+01:00').reward(10,100).repeat(WEEKLY,2).show(true).priority(1).gatekeeper(event(B))";
